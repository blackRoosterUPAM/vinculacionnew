							...
							<div class="d-flex flex-stack flex-wrap flex-lg-nowrap gap-4 gap-lg-10 pt-6 pb-18 py-lg-13">
								...
								<div class="page-title d-flex align-items-center me-3">
									...
									<h1 class="page-heading d-flex text-white fw-bolder fs-2 flex-column justify-content-center my-0">Listado General
										<!--begin::Description-->
										<span class="page-desc text-white opacity-50 fs-6 fw-bold pt-4">Vacantes</span>
										<!--end::Description-->
									</h1>
									<!--end::Title-->
								</div>
										...
										<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
											<thead>
												<tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
													<th style="text-align: center;"">IdSede</th>
													<th style="text-align: center;"">Perfil</th>
													<th style="text-align: center;"">Beneficios</th>
													<th style="text-align: center;"">N° Vacantes</th>
													<th style="text-align: center;"">Nombre Sede</th>
											...
											<tbody class="fw-semibold text-gray-600">
												...
												$sql = "select v.IdSede,v.Perfil,v.Beneficios,v.NumVacantes,s.NombreSede,s.tiposede,p.NombrePE,c.nombreCarrera,pd.Meses,pd.anio
												from vacantes as v
												INNER JOIN sede as s on v.IdSede = s.IdSede
												INNER JOIN proceso as p on v.IdProceso = p.IdProceso
												INNER JOIN carrera as c on v.IdCarrera = c.IdCarrera
												INNER JOIN periodo as pd on v.IdPeriodo = pd.IdPeriodo;";
												...
												if ($result->num_rows > 0) { // output data of each row
													while ($row = $result->fetch_assoc()) {
														...
														echo "<td align='center'>" . $row["anio"] . "</td></tr>";
													} 
												} else {
