...
<head>
	...
	<link rel="shortcut icon" href="../vinculacionf/assets/media/logos/upam.ico" />
							...
							<div class="d-flex flex-stack flex-wrap flex-lg-nowrap gap-4 gap-lg-10 pt-6 pb-18 py-lg-13">
								...
								<div class="page-title d-flex align-items-center me-3">
									...
									<h1 class="page-heading d-flex text-white fw-bolder fs-2 flex-column justify-content-center my-0">Listado General
										<!--begin::Description-->
										<span class="page-desc text-white opacity-50 fs-6 fw-bold pt-4">Documentos</span>
										<!--end::Description-->
									</h1>
									<!--end::Title-->
								</div>
										...
										<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
											<thead>
												<tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
													...
													<th style="text-align: center;">Estatus PTC</th>
													<th style="text-align: center;">Estatus Vinc.</th>
