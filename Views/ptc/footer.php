<div id="kt_app_footer" class="app-footer d-flex flex-column flex-md-row align-items-center flex-center flex-md-stack py-2 py-lg-4">
								...
								<ul class="menu menu-gray-600 menu-hover-primary fw-semibold order-1">
									<li class="menu-item">
										<a href="https://www.facebook.com/UPAMOZOC/?locale=es_LA" target="_blank" class="menu-link px-2">Facebook</a>
									</li>
									<li class="menu-item">
										<a href="https://www.instagram.com/upamozoc/?hl=es" target="_blank" class="menu-link px-2">Instagram</a>
									</li>
									<li class="menu-item">
